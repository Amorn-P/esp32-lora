...
// Weak callback - override in your project to stop relays/systems before OTA
void __attribute__((weak)) CommCore_OTA_PreUpdateCallback() {
  // Default: no action. Override this function in your project.
}
...
void performOTAUpdate() {
  ...
  // Safety: call project-specific stop callback
  Blynk.virtualWrite(V122, "Stopping systems...");
  CommCore_OTA_PreUpdateCallback();
