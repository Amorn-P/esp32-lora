...
BLYNK_WRITE(V126) { BlynkRst_Hr_int = String(param.asString()).toInt(); EEPROM.put(100,BlynkRst_Hr_int); EEPROM.commit(); }
BLYNK_WRITE(V127) { BlynkRst_Min_int = String(param.asString()).toInt(); EEPROM.put(110,BlynkRst_Min_int); EEPROM.commit(); }
